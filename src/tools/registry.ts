...
/** The active tool set (`lsp` joins in Phase 2). `let`, not `const`, so `reloadTools` can swap it. */
export let tools: Tool[] = [read, write, edit, bash, ls, grep, glob, manual, askUser];
